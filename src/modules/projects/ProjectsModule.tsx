      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="flex justify-between items-center mb-6 border-b border-text-muted/20 pb-4 relative z-10">
            <div>
               ...
               <span className="font-mono text-xs text-text-secondary mt-1 block">Social Media Platform — Short Video / Creator Economy</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 relative z-10">
            <div className="flex-1">
               <p className="font-mono text-sm text-text-primary mb-4 leading-relaxed">
                 Backend services for a short-video social media platform using Java, Spring Boot, Microservices, Redis, and MySQL — covering creator monetization, personalized feeds, and automated financial settlement.
               </p>
               
               <ul className="text-text-secondary font-mono text-[11px] space-y-2 ml-4 list-disc mb-6">
                 <li>Built creator monetization workflows covering scoring, rewards, payouts, and settlements.</li>
                 <li>Designed a Redis-backed personalized feed and recommendation system using user activity and engagement data.</li>
                 <li>Automated settlement and payout workflows with Excel reports, SFTP processing, and IMPS integration.</li>
                 <li>Optimized high-volume Redis view/engagement processing with async and batched operations on AWS EC2.</li>
               </ul>
               ...
               <div className="flex flex-wrap gap-2 font-mono text-[10px]">
                 ...
                 <span className="bg-[#F29111]/10 text-[#F29111] border border-[#F29111]/30 px-2 py-0.5">MySQL</span>
               </div>
            </div>
          ...
          <div className="flex justify-between items-center mb-6 border-b border-text-muted/20 pb-4 relative z-10">
            <div>
               <div className="flex flex-wrap items-center gap-3">
                 ...
                 <span className="font-mono text-[9px] bg-[#25D366]/20 text-[#25D366] px-2 py-1 font-bold border border-[#25D366]/30 animate-pulse">WHATSAPP + SMS</span>
               </div>
               <span className="font-mono text-xs text-text-secondary mt-1 block">Vehicle Rental Ecosystem — Customer & Owner Mobile Apps</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 relative z-10">
            <div className="flex-[1.2]">
               <p className="font-mono text-sm text-text-primary mb-4 leading-relaxed font-bold">
                 Designed and developed the backend architecture and REST APIs using Laravel, supporting customer and vehicle-owner mobile apps.
               </p>
               
               <ul className="text-text-secondary font-mono text-[11px] space-y-2 ml-4 list-disc mb-6">
                 <li><strong className="text-accent-primary font-bold">Core Workflows:</strong> Vehicle listing, search, booking, scheduling, pricing, and payment flows.</li>
                 <li><strong className="text-accent-primary font-bold">Rewards Engine:</strong> Referral bonus and coupon systems covering rewards, eligibility, and discounts.</li>
                 <li><strong className="text-accent-primary font-bold">Comms:</strong> WhatsApp notifications for booking confirmations and status updates, plus SMS-based OTP authentication.</li>
                 <li><strong className="text-accent-primary font-bold">Access Control:</strong> Auth and RBAC for customers, vehicle owners, and admins — with a React.js admin portal for vehicle, booking, pricing, and approvals.</li>
               </ul>

               <div className="flex flex-wrap gap-2 font-mono text-[10px]">
                 <span className="bg-[#FF2D20]/10 text-[#FF2D20] border border-[#FF2D20]/30 px-2 py-0.5">Laravel</span>
                 <span className="bg-[#61DAFB]/10 text-[#61DAFB] border border-[#61DAFB]/30 px-2 py-0.5">React.js</span>
                 <span className="bg-[#F29111]/10 text-[#F29111] border border-[#F29111]/30 px-2 py-0.5">MySQL</span>
            ...
            <div className="flex-1 w-full bg-[#050505] border border-text-muted/10 relative overflow-hidden flex flex-col p-6 items-center justify-center min-h-[250px]">
               ...
               <div className="w-full flex justify-between items-center z-10 max-w-[200px] mt-8">
                  <div className="text-[8px] font-mono border border-[#FF2D20]/50 text-[#FF2D20] p-1.5 bg-[#111]">PAYMENTS</div>
                  <div className="text-[8px] font-mono border border-[#25D366]/50 text-[#25D366] p-1.5 bg-[#111]">WHATSAPP</div>
                  <div className="text-[8px] font-mono border border-text-primary/50 text-text-primary p-1.5 bg-[#111]">SMS OTP</div>
               </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
               <p className="font-mono text-xs font-bold text-white mb-2">Incubation Management Portal</p>
               <ul className="text-text-secondary font-mono text-xs space-y-1 ml-4 list-disc mb-4">
                 <li>Web portal for managing incubation programs, startups, events, blogs, and notifications.</li>
                 <li>Admin dashboard with charts, reports, search, document management, and email alerts.</li>
                 <li>Laravel backend workflows and MySQL integration supporting platform management operations.</li>
               </ul>
